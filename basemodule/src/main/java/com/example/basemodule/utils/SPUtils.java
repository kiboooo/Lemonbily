...
public class SPUtils {
    private static final String FILE_NAME = "lemonbily_cache";
    ...
    public static <E> void put(@NonNull String key, @NonNull E value) {
        put(BaseApplication.getContext(), key, value);
    }
    ...
    public static <E> E get(@NonNull String key, @NonNull E defaultValue) {
        ...
        return get(BaseApplication.getContext(), key, defaultValue);
    }
    ...
    public static boolean contains(String key) {
        return contains(BaseApplication.getContext(), key);
    }
